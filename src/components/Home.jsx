...
export const Home = () => {
  ...
  const t = {
    en: {
      ...
      introDesc1: 'Step back in time to the golden age of Prohibition. Behind closed doors, under a single brass spotlight, a game of life, death, and deception is played. Mafia Club Nights organizes premium, fully immersive social deduction events where alliances are forged and broken in seconds.',
    ...
    ar: {
      ...
      introDesc1: 'خطوة إلى الوراء بالزمن لعصر الحظر الذهبي. خلف الأبواب المغلقة وتحت تسليط ضوء خافت، تُلعب لعبة حياة وموت وخداع. تنظم ليالي نادي المافيا فعاليات حماسية غامرة بالكامل تعتمد على الاستنتاج الاجتماعي والتحالفات التي تُبنى وتنهار في ثوانٍ.',
